...
**TASK 4.2** Is the default 0.5 threshold sensible?  Consider prevalence and
...
**TASK 7.1** Document one change you tried and its effect on AUC or the map.
...
* Knit this notebook → HTML, confirm that
  – all **TASK** answers are filled in,   
